...
namespace EFaturaApp
{
    public partial class TopluFatura : BaseForm
    {
            ...
            try
            {
                ...
                //--peşin havle şubeye göre
                        ...
                        if (radDropDownList1.SelectedIndex == 1)
                        {
                            ...
                            {
                                RadMessageBox.Show("Lütfen Gönderen Şubeyi Seçiniz.", "Dikkat !!", MessageBoxButtons.OK, RadMessageIcon.Error);
                            }
                        }
                        ...
                        if (radDropDownList1.SelectedIndex == 2)
                        {
                            ...
                            {
                               RadMessageBox.Show("Lütfen Alıcı Şubeyi Seçiniz.", "Dikkat !!", MessageBoxButtons.OK, RadMessageIcon.Error);
                            }
                        }
                ...
                {
                    sum += Convert.ToDouble((!radGridView1.Rows[i].Cells["yekun1"].Value.Equals(DBNull.Value)) ? radGridView1.Rows[i].Cells["yekun1"].Value : "0");
        ...
        void Satirgetir(int satirno)
        {
            try
            {
                string sorguhar = "select miktar,birimi,agirlik,carpan,cinsi,fiyati,tutari,musirsno,ref from tesellumhar where takipseri='" + radGridView1.Rows[satirno].Cells["takipseri"].Value.ToString() + "' and fatno='" + radGridView1.Rows[satirno].Cells["takipno"].Value.ToString() + "'";
        ...
        //        MessageBox.Show("İşaretlenmiş Tüm Faturalar Kesildi.", "Bilgilendirme", MessageBoxButtons.OK, MessageBoxIcon.Information);
        //        listeleme(listedurum);
        //    }
        //    catch (Exception ex)
        //    {
        //        MessageBox.Show("Sistemsel bir hata oluştu. Lütfen Tekrar deneyiniz. \r\n" + ex.Message, "Hata Oluştu", MessageBoxButtons.OK);
        //        listeleme(listedurum);
        //    }
        //}
        //void temizle()
        ...
        //    cmd.Parameters.AddWithValue("@P36", textBox5.Text).SqlDbType = SqlDbType.VarChar;
        ...
        {
            if (MessageBox.Show("Seçili Faturaları Kesmek istediğinize emin misiniz ?\n\n", "Bilgilendirme", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
